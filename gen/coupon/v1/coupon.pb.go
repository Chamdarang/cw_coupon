...
func (x *CreateCampaignRequest) GetStartTimestamp() int64 {
	if x != nil {
...
func (x *GetCampaignResponse) GetStartTimestamp() int64 {
	if x != nil {
		return x.StartTimestamp
	}
	return 0
...
func (x *GetCampaignResponse) GetTotalCoupons() int32 {
	if x != nil {
		return x.TotalCoupons
	}
	return 0
...
const file_coupon_v1_coupon_proto_rawDesc = "" +
	...
	"\vIssueCoupon\x12\x1d.coupon.v1.IssueCouponRequest\x1a\x1e.coupon.v1.IssueCouponResponseB\x1fZ\x1dcoupon/gen/coupon/v1;couponv1b\x06proto3"
